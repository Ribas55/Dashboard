...
flowchart TD
    ...
    %% Styling with vibrant clean colors and strong black borders
    classDef extraction fill:#4285f4,stroke:#000000,stroke-width:4px,color:#ffffff
    classDef processing fill:#34a853,stroke:#000000,stroke-width:4px,color:#ffffff
    classDef analysis fill:#ff9800,stroke:#000000,stroke-width:4px,color:#ffffff
    classDef output fill:#9c27b0,stroke:#000000,stroke-width:4px,color:#ffffff
